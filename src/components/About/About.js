...
const ourInfo = [
  new Person("Aly Stroud", "Developer", alyPicture,
  ...
  new Person("Arka Raina", "UX Designer", arkaPicture,
      ...
      "", "", ""),
  new Person("Imane Kaddo", "Designer", imanePicture, 
      ...
      "", "", ""),
  new Person("Lawrencia Njume", "Developer", lawrenciaPicture, 
  ...
  new Person("Megan John", "Developer", meganPicture,
